...
export default function SolicitudProductoPage() {
  const { user } = useAuth();
  ...
  async function handleSubmit(e) {
    ...
    if (!nombre || !descripcion || !precio || !idEmpresa || !empresa) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-green-100 py-10">
      ...
      >
        ...
        <label className="block mb-2 font-semibold">Nombre del producto</label>
        <input
